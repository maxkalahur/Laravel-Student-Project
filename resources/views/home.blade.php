    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 col-md-offset-0">
                <a href="{{route('news.create')}}" class="btn btn-danger btn-group btn-block">
                    Create new news
                </a>
            </div>
        <div class="col-md-5 col-md-offset-2">
            <a href="{{route('articles.create')}}" class="btn btn-danger btn-group btn-block">
                   Create new article
            </a>
        </div>
    </div>
        ...
        <div class="col-md-6">
            ...
            @foreach($news as $new)
                    ...
                    <tr><td>
                            ...
                            <a href="{{route('news.edit', $new->id)}}" class="btn btn-success">update</a>
                        </td></tr>
            @endforeach
            </table>
        </div>
